...
const langs = {
  ...
  en: {
    ...
    TCG: "Genius Invokation TCG",
    TCGRank: "Player Level",
    TCGHandbook: "TCG Player's Manual",
    resetAll: "reset all",
    reset: "reset",
  ...
  fr: {
    ...
    TCG: "Invocation des Sept : JCC",
    TCGRank: "Niv. de joueur",
    TCGHandbook: "Guide de joueur",
